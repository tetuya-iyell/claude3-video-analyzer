...
# 台本形式のガイドライン
- 元の台本では「話者1:」「話者2:」のような表記が使われています
- 改善版では「れいむ:」「まりさ:」「ナレーション:」のように明確な話者名に変更してください
- ゆっくり実況形式（「～です」「～ます」調）を維持
- 専門用語は噛み砕いて説明する
- 重要ポイントには「！」マークを付ける
- 台詞をリアルに聞こえるよう自然な会話調で書く
...
フィードバックを反映した改善版台本を作成してください。元の台本形式を踏襲しつつ、話者を「れいむ:」「まりさ:」「ナレーション:」のように明確にしてください。
