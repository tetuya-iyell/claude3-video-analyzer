...
フィードバックを反映した改善版台本を作成してください。台本形式の基本は維持しながら、話者名を「れいむ」「まりさ」「ナレーション」に変更し、内容を改善してください。
...
# 台本の長さ
{duration_minutes}分程度の動画向け台本（目安: 1分あたり約150字）
...
7. 指定された動画時間に合わせて、適切な台本の長さになるよう調整してください
